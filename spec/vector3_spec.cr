describe "Vector3" do
  ...
  describe "scale up" do
    it "should scale with 0" do
      (Vector3.new(192.38,128,-3.21) * 0).should eq(Vector3.new(0,0,0))
    end
    it "should scale with -1" do
      (Vector3.new(192.38,128,-3.21) * -1).should eq(Vector3.new(-192.38,-128,3.21))
    end
  end

  describe "scale down" do
    it "should scale down with 2" do
      (Vector3.new(192.38,128,-3.21) / 2).should eq(Vector3.new(96.19, 64, -1.605))
    end
  end
